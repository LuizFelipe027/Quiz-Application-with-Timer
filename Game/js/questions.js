...
let listQuestions = [
    ...
    {
    numb: 2,
    question: "Qual alternativa descreve o que é Sazonalidade?",
    problem: "A sazonalidade afeta o estoque e caixa de várias empresas.",
    ...
    {
    numb: 3,
    question: " Abaixo marque a opção que os descrevam:",
    problem: "Existem elementos principais nos modelos de analises de demanda. .",
    ...
    {
    numb: 5,
    question: "O que não é provável acontecer? ",
    problem: "Suponha-se que a demanda esteja maior que a produção. ",
    ...
    {
    numb: 6,
    question: "Assinale a alternativa que se refere ao que pode acontecer em casos de ruptura:",
    problem: "A ruptura de estoque é um fator negativo para empresas, gerando situações desagradáveis.",
  ...
  {
    numb: 7,
    question: "Sobre a ruptura, responda:",
    problem: "Quais das alternativas é uma causa de ruptura?",
    ...
    {
    numb: 8,
    question: "Assinale a alternativa que corresponde a alguns de fatores convenientes: ",
    problem: "Caso queira um caixa cheio, é primordial que exista uma previsão útil referente a demandas.",
    ...
    {
    numb: 9,
    question: "Marque a alternativa que mostre uma das consequências:",
    problem: "Sobre a ruptura de estoque.",
    ...
    {
    numb: 10,
    question: "Por que João tem essa dor?",
    problem: "João é responsável pelo setor de vendas de um supermercado e sente a dor quando falta ou sobra de alguma mercadoria.",
    ...
    {
    numb: 11,
    question: "O que ocasiona:",
    problem: "Sabemos que o período que mais são vendidos acondicionados são nos meses de dezembro, janeiro e fevereiro, caso o fornecedor tenha falta de insumos e só consiga entregar as peças depois do prazo.",
    answer: "Aumento da oferta que causa uma queda no preço da mercadoria.",
    options: [
    ...
    {
    numb: 12,
    question: "Quais das alternativas se aplicam as análises antes da tomada de decisão?",
    problem: "O período com maior quantidade de itens vendidos em uma papelaria é no tempo de volta as aulas.",
